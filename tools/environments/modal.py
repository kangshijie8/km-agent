...
wrapper, while preserving Kunming's persistent snapshot behavior across sessions.
"""
...
_SNAPSHOT_STORE = get_kunming_home() / "modal_snapshots.json"
...
class ModalEnvironment(BaseEnvironment):
    ...
    def __init__(
        ...
        async def _create_sandbox(image_spec: Any):
            app = await _modal.App.lookup.aio("kunming-agent", create_if_missing=True)
