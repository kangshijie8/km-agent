...
Trust levels:
  - builtin:   Ships with Kunming. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.kunming/\.env|\~/\.kunming/\.env',
     "kunming_env_access", "critical", "exfiltration",
     "directly references Kunming secrets file"),
    ...
    (r'\.kunming/config\.yaml|\.kunming/SOUL\.md',
     "kunming_config_mod", "critical", "persistence",
     "references Kunming configuration files directly"),
...
def _get_configured_model() -> str:
    """Load the user's configured model from ~/.kunming/config.yaml."""
    try:
