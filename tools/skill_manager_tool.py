...
~/.kunming/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.kunming/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.kunming/skills/) first, then any
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "New skills go to ~/.kunming/skills/; existing skills can be modified wherever they live.\n\n"
