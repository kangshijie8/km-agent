...
class DiscordAdapter(BasePlatformAdapter):
    ...
    async def on_processing_start(self, event: MessageEvent) -> None:
        ...
        if hasattr(message, "add_reaction"):
            await self._add_reaction(message, "ð")
    ...
    async def on_processing_complete(self, event: MessageEvent, success: bool) -> None:
        ...
        message = event.raw_message
        if hasattr(message, "add_reaction"):
            await self._remove_reaction(message, "ð")
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your Kunming session")
        ...
        @tree.command(name="status", description="Show Kunming session status")
        ...
        @tree.command(name="stop", description="Stop the running Kunming agent")
        ...
        @tree.command(name="update", description="Update Kunming Agent to the latest version")
        ...
        @tree.command(name="thread", description="Create a new thread and start a Kunming session in it")
        @discord.app_commands.describe(
            name="Thread name",
            message="Optional first message to send to Kunming in the thread",
        ...
        try:
            from kunming_cli.commands import discord_skill_commands
    ...
    async def _handle_thread_create_slash(
        ...
        # If a message was provided, kick off a new Kunming session in the thread
    ...
    async def _create_thread(
        ...
        *,
        ...
        try:
            ...
            try:
                seed_content = starter_message or f"\U0001f9f5 Thread created by Kunming: **{name}**"
    ...
    async def _auto_create_thread(self, message: 'DiscordMessage') -> Optional[Any]:
        ...
        thread_name = content[:80] if content else "Kunming"
        if len(content) > 80:
    ...
    async def send_exec_approval(
        ...
        try:
            ...
            embed = discord.Embed(
                title="â ï¸ Command Approval Required",
                description=f"```\n{cmd_display}\n```",
    ...
    async def send_update_prompt(
        ...
        try:
            ...
            embed = discord.Embed(
                title="[ON]Update Needs Your Input",
    ...
    def _thread_state_path() -> Path:
        ...
        return get_kunming_home() / "discord_threads.json"
...
if DISCORD_AVAILABLE:
    ...
    class UpdatePromptView(discord.ui.View):
        """Interactive Yes/No buttons for ``km update`` prompts.
