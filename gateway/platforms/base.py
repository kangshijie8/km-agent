...
# Default location: {KUNMING_HOME}/cache/images/ (legacy: image_cache/)
IMAGE_CACHE_DIR = get_kunming_dir("cache/images", "image_cache")
...
AUDIO_CACHE_DIR = get_kunming_dir("cache/audio", "audio_cache")
...
DOCUMENT_CACHE_DIR = get_kunming_dir("cache/documents", "document_cache")
...
class BasePlatformAdapter(ABC):
    ...
    def _get_human_delay() -> float:
        ...
        Reads from env vars:
          KUNMING_HUMAN_DELAY_MODE: "off" (default) | "natural" | "custom"
        ...
        if mode == "off":
            return 0.0
        min_ms = int(os.getenv("KUNMING_HUMAN_DELAY_MIN_MS", "800"))
        max_ms = int(os.getenv("KUNMING_HUMAN_DELAY_MAX_MS", "2500"))
        if mode == "natural":
