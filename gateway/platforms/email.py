"""
Email platform adapter for the Kunming gateway.

Allows users to interact with Kunming by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Kunming Agent")
        ...
        msg_id = f"<kunming-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
