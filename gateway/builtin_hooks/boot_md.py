"""Built-in boot-md hook — run ~/.kunming/BOOT.md on gateway startup.

This hook is always registered. It silently skips if no BOOT.md exists.
To activate, create ``~/.kunming/BOOT.md`` with instructions for the
...
BOOT_FILE = KUNMING_HOME / "BOOT.md"
