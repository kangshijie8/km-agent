...
Usage:
    kunming pairing list              # Show all pending + approved users
    kunming pairing approve <platform> <code>  # Approve a pairing code
    kunming pairing revoke <platform> <user_id> # Revoke user access
    kunming pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle kunming pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: kunming pairing {list|approve|revoke|clear-pending}")
        print("Run 'kunming pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'kunming pairing list' to see pending codes.\n")
