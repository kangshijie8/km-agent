...
COMMON_KUNMING_TOOLS = ["read_file", "search_files", "terminal", "patch", "write_file", "process"]


class TestToolKindMap:
    def test_all_KUNMING_tools_have_kind(self):
        """Every common kunming tool should appear in TOOL_KIND_MAP."""
        for tool in COMMON_KUNMING_TOOLS:
