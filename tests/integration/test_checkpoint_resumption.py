...
def test_current_implementation():
    ...
    print("=" * 70)
    print("\n[CONFIG] Testing whether checkpoints are saved incrementally during run...")
    ...
    if len(snapshots) == 0:
        ...
        print("\n[!]  WARNING: Only 1 checkpoint update (likely at the end)")
...
def test_interruption_and_resume():
    ...
    print("=" * 70)
    print("\n[CONFIG] Testing whether resume works after manual interruption...")
...
def test_simulated_crash():
    ...
    print("=" * 70)
    print("\n[CONFIG] This test would require running in a subprocess and killing it...")
