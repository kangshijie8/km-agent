"""Tests for kunming_state.py — SessionDB SQLite CRUD, FTS5 search, export."""
...
class TestSanitizeTitle:
    ...
    def test_unicode_emoji_allowed(self):
        assert SessionDB.sanitize_title("[READY] My Project 🎉") == "[READY] My Project 🎉"
...
class TestConcurrentWriteSafety:
    ...
    def test_sqlite_timeout_is_at_least_30s(self, db):
        ...
        import sqlite3
        import inspect
        from kunming_state import SessionDB as _SessionDB
