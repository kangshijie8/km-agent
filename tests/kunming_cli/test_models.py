"""Tests for the kunming_cli models module."""
...
import kunming_cli.models as _models_mod
...
class TestFindOpenrouterSlug:
    def test_exact_match(self):
        from kunming_cli.models import _find_openrouter_slug
...
class TestCheckNousFreeTierCache:
    ...
    @patch("kunming_cli.models.fetch_nous_account_tier")
    @patch("kunming_cli.models.is_nous_free_tier", return_value=True)
    def test_result_is_cached(self, mock_is_free, mock_fetch):
        ...
        with patch("kunming_cli.auth.get_provider_auth_state", return_value={"access_token": "tok"}), \
             patch("kunming_cli.auth.resolve_nous_runtime_credentials"):
    ...
    @patch("kunming_cli.models.fetch_nous_account_tier")
    @patch("kunming_cli.models.is_nous_free_tier", return_value=False)
