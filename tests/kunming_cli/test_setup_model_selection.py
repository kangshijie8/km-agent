...
class TestSetupProviderModelSelection:
    ...
    @patch("kunming_cli.models.fetch_api_models", return_value=[])
    @patch("kunming_cli.config.get_env_value", return_value="fake-key")
    def test_falls_back_to_default_models_without_crashing(
        ...
        from kunming_cli.setup import _setup_provider_model_selection
        ...
        with patch("kunming_cli.auth.PROVIDER_REGISTRY", mock_provider_registry):
    ...
    @patch("kunming_cli.models.fetch_api_models")
    @patch("kunming_cli.config.get_env_value", return_value="fake-key")
    ...
    def test_custom_model_selection(
        ...
        from kunming_cli.setup import _setup_provider_model_selection, _DEFAULT_PROVIDER_MODELS
    ...
    @patch("kunming_cli.models.fetch_api_models", return_value=["opencode-go/kimi-k2.5", "opencode-go/minimax-m2.7"])
    @patch("kunming_cli.config.get_env_value", return_value="fake-key")
