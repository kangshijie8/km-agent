...
class TestSkinConfig:
    ...
    def test_get_branding_with_fallback(self):
        from kunming_cli.skin_engine import load_skin
        skin = load_skin("default")
        assert skin.get_branding("agent_name") == "Kunming Agent"
...
class TestUserSkins:
    def test_load_user_skin_from_yaml(self, tmp_path, monkeypatch):
        from kunming_cli.skin_engine import load_skin, _skins_dir
        ...
        # Patch skins dir
        monkeypatch.setattr("kunming_cli.skin_engine._skins_dir", lambda: skins_dir)
