...
subparser, placing the flag BEFORE the subcommand (e.g. 'kunming --yolo chat')
...
def _build_parser():
    """Build the kunming argument parser from the real code.
    ...
    """
    parser = argparse.ArgumentParser(prog="kunming")
...
class TestYoloEnvVar:
    """Verify --yolo sets KUNMING_YOLO_MODE regardless of flag position.
    ...
    def test_yolo_before_chat_sets_env(self):
        ...
        assert os.environ.get("KUNMING_YOLO_MODE") == "1"
    ...
    def test_no_yolo_no_env(self):
        ...
        args = parser.parse_args(["chat"])
        self._simulate_cmd_chat_yolo_check(args)
        assert os.environ.get("KUNMING_YOLO_MODE") is None
