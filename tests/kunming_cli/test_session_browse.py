"""Tests for the interactive session browser (`kunming sessions browse`).
...
from kunming_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """kunming sessions browse should be parseable."""
        from kunming_cli.main import main as _main_entry
