...
from kunming_cli.setup import setup_model_provider
...
def test_modal_setup_can_use_nous_subscription_without_modal_creds(tmp_path, monkeypatch, capsys):
    ...
    monkeypatch.setattr("kunming_cli.setup.prompt", fake_prompt)
    monkeypatch.setattr("kunming_cli.setup._prompt_container_resources", lambda config: None)
    monkeypatch.setattr(
    ...
    from kunming_cli.setup import setup_terminal_backend
...
def test_modal_setup_persists_direct_mode_when_user_chooses_their_own_account(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("kunming_cli.setup.prompt_choice", fake_prompt_choice)
    monkeypatch.setattr("kunming_cli.setup.prompt", lambda *args, **kwargs: next(prompt_values))
    monkeypatch.setattr("kunming_cli.setup._prompt_container_resources", lambda config: None)
    monkeypatch.setattr(
        "kunming_cli.setup.get_nous_subscription_features",
        lambda config: type("Features", (), {"nous_auth_present": True})(),
