from kunming_cli import runtime_provider as rp
...
def test_named_custom_provider_does_not_shadow_builtin_provider(monkeypatch):
    ...
    assert resolved["base_url"] == "https://inference-api.kunming.dev/v1"
...
def test_resolve_requested_provider_precedence(monkeypatch):
    monkeypatch.setenv("KUNMING_INFERENCE_PROVIDER", "nous")
...
def test_resolve_provider_custom_returns_custom():
    ...
    from kunming_cli.auth import resolve_provider
