...
class TestToolsetConsistency:
    ...
    def test_KUNMING_platforms_share_core_tools(self):
        """All kunming-* platform toolsets should have the same tools."""
        platforms = ["kunming-cli", "kunming-telegram", "kunming-discord", "kunming-whatsapp", "kunming-slack", "kunming-signal", "kunming-homeassistant"]
