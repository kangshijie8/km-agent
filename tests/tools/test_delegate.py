...
class TestToolNamePreservation(unittest.TestCase):
    ...
    def test_global_tool_names_restored_after_delegation(self):
        ...
        model_tools._set_resolved_tool_names(list(original_tools))
    ...
    def test_saved_tool_names_set_on_child_before_run(self):
        ...
        model_tools._set_resolved_tool_names(list(expected_tools))
...
class TestDelegationCredentialResolution(unittest.TestCase):
    ...
    def test_nous_provider_resolves_nous_credentials(self, mock_resolve):
        ...
        parent = _make_mock_parent(depth=0)
        cfg = {"model": "kunming-3-llama-3.1-8b", "provider": "nous"}
        creds = _resolve_delegation_credentials(cfg, parent)
        self.assertEqual(creds["provider"], "nous")
        self.assertEqual(creds["base_url"], "https://inference-api.kunming.dev/v1")
...
class TestDelegationProviderIntegration(unittest.TestCase):
    ...
    def test_cross_provider_delegation(self, mock_creds, mock_cfg):
        ...
        parent.base_url = "https://inference-api.kunming.dev/v1"
