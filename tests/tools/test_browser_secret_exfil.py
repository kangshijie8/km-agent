...
def _ensure_redaction_enabled(monkeypatch):
    """Ensure redaction is active regardless of host KUNMING_REDACT_SECRETS."""
    monkeypatch.delenv("KUNMING_REDACT_SECRETS", raising=False)
...
class TestBrowserSecretExfil:
    ...
    def test_allows_normal_url(self):
        ...
        from tools.browser_tool import browser_navigate
        result = browser_navigate("https://github.com/kangshijie8/KM-Agent")
        parsed = json.loads(result)
