...
class TestTerminalIntegration:
    ...
    def test_blocklisted_var_blocked_by_default(self):
        from tools.environments.local import _sanitize_subprocess_env, _KUNMING_PROVIDER_ENV_BLOCKLIST

        # Pick a var we know is in the blocklist
        blocked_var = next(iter(_KUNMING_PROVIDER_ENV_BLOCKLIST))
    ...
    def test_make_run_env_passthrough(self, monkeypatch):
        from tools.environments.local import _make_run_env, _KUNMING_PROVIDER_ENV_BLOCKLIST
