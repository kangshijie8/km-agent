...
class TestWriteDenyExactPaths:
    ...
    def test_KUNMING_env(self):
        path = os.path.join(str(Path.home()), ".kunming", ".env")
        assert _is_write_denied(path) is True
...
class TestWriteAllowed:
    ...
    def test_KUNMING_config_not_env(self):
        path = os.path.join(str(Path.home()), ".kunming", "config.yaml")
