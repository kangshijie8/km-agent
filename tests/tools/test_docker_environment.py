...
def _make_execute_only_env(forward_env=None):
    ...
    env._snapshot_path = "/tmp/kunming-snap-test123.sh"
    env._cwd_file = "/tmp/kunming-cwd-test123.txt"
    env._cwd_marker = "__KUNMING_CWD_test123__"
...
def test_init_env_args_uses_KUNMING_dotenv_for_allowlisted_env(monkeypatch):
...
def test_init_env_args_prefers_shell_env_over_KUNMING_dotenv(monkeypatch):
