...
class TestHeredocMarker:
    ...
    def test_uuid_marker_on_collision(self):
        ...
        assert marker.startswith("KUNMING_PERSIST_")
...
class TestWriteToSandbox:
    def test_success(self):
        ...
        result = _write_to_sandbox("hello world", "/tmp/kunming-results/abc.txt", env)
    ...
    def test_failure_returns_false(self):
        ...
        result = _write_to_sandbox("content", "/tmp/kunming-results/abc.txt", env)
    ...
    def test_heredoc_collision_uses_uuid_marker(self):
        ...
        _write_to_sandbox(content, "/tmp/kunming-results/abc.txt", env)
        cmd = env.execute.call_args[0][0]
...
class TestBuildPersistedMessage:
    def test_structure(self):
        msg = _build_persisted_message(
            ...
            file_path="/tmp/kunming-results/test123.txt",
        )
        ...
        assert "/tmp/kunming-results/test123.txt" in msg
    ...
    def test_no_ellipsis_when_complete(self):
        msg = _build_persisted_message(
            ...
            has_more=False,
            original_size=16,
            file_path="/tmp/kunming-results/x.txt",
        )
    ...
    def test_large_size_shows_mb(self):
        msg = _build_persisted_message(
            ...
            file_path="/tmp/kunming-results/big.txt",
        )
        assert "MB" in msg
