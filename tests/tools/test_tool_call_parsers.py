...
class TestParserRegistry:
    ...
    def test_kunming_parser_registered(self):
        parsers = list_parsers()
        assert "kunming" in parsers
...
# --- Kunming parser tests ------------------------------------------------

class TestKunmingParser:
    @pytest.fixture
    def parser(self):
        return get_parser("kunming")
...
class TestParseResultContract:
    ...
    @pytest.fixture(params=["kunming"])  # Add more as needed
    ...
    def test_tool_calls_are_proper_objects(self, parser):
        ...
        # Use kunming format since that's universal
