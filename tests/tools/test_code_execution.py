...
UDS socket lifecycle, KUNMING_tools generation, timeout enforcement,
...
class TestKunmingToolsGeneration(unittest.TestCase):
    def test_generates_all_allowed_tools(self):
        src = generate_kunming_tools_module(list(SANDBOX_ALLOWED_TOOLS))
        for tool in SANDBOX_ALLOWED_TOOLS:
            self.assertIn(f"def {tool}(", src)

    def test_generates_subset(self):
        src = generate_kunming_tools_module(["terminal", "web_search"])
    ...
    def test_empty_list_generates_nothing(self):
        src = generate_kunming_tools_module([])
    ...
    def test_non_allowed_tools_ignored(self):
        src = generate_kunming_tools_module(["vision_analyze", "terminal"])
        self.assertIn("def terminal(", src)
        self.assertNotIn("def vision_analyze(", src)

    def test_rpc_infrastructure_present(self):
        src = generate_kunming_tools_module(["terminal"])
        self.assertIn("KUNMING_RPC_SOCKET", src)
...
class TestExecuteCode(unittest.TestCase):
    ...
    def test_repo_root_modules_are_importable(self):
        ...
        result = self._run('import kunming_constants; print(kunming_constants.__file__)')
        self.assertEqual(result["status"], "success")
        self.assertIn("kunming_constants.py", result["output"])

    def test_single_tool_call(self):
        """Script calls terminal and prints the result."""
        code = """
from KUNMING_tools import terminal
...
"""
    ...
    def test_multi_tool_chain(self):
        ...
        code = """
from KUNMING_tools import terminal, read_file
r1 = terminal("ls")
...
"""
        ...
        # terminal won't be in KUNMING_tools.py, so import fails
        self.assertEqual(result["status"], "error")
...
"""
    ...
    def test_web_search_tool(self):
        ...
        code = """
from KUNMING_tools import web_search
...
"""
    ...
    def test_json_parse_helper(self):
        ...
        code = r"""
from KUNMING_tools import json_parse
...
"""
    ...
    def test_shell_quote_helper(self):
        ...
        code = """
from KUNMING_tools import shell_quote
...
"""
    ...
    def test_retry_helper_success(self):
        ...
        code = """
from KUNMING_tools import retry
counter = [0]
def flaky():
    counter[0] += 1
...
class TestBuildExecuteCodeSchema(unittest.TestCase):
    ...
    def test_real_scenario_all_sandbox_tools_disabled(self):
        ...
        Scenario: user runs `km tools code_execution` (only code_execution
    ...
    def test_real_scenario_only_vision_enabled(self):
        """Another real path: user runs `km tools code_execution,vision`.
...
class TestEnvVarFiltering(unittest.TestCase):
    ...
    def test_kunming_rpc_socket_injected(self):
        child_env = self._get_child_env()
        self.assertIn("KUNMING_RPC_SOCKET", child_env)
...
class TestExecuteCodeEdgeCases(unittest.TestCase):
    ...
    def test_none_enabled_tools_uses_all(self):
        ...
        code = (
            "from KUNMING_tools import terminal, web_search, read_file\n"
    ...
    def test_empty_enabled_tools_uses_all(self):
        ...
        code = (
            "from KUNMING_tools import terminal, web_search\n"
            "print('imports ok')\n"
        )
        with patch("model_tools.handle_function_call",
                    return_value=json.dumps({"ok": True})):
