...
class TestCronjobRequirements:
    def test_requires_no_crontab_binary(self, monkeypatch):
        ...
        # because kunming uses an internal scheduler, not system crontab.
    ...
    def test_accepts_gateway_session(self, monkeypatch):
        ...
        monkeypatch.setenv("KUNMING_GATEWAY_SESSION", "1")
        monkeypatch.delenv("KUNMING_EXEC_ASK", raising=False)
    ...
    def test_accepts_exec_ask(self, monkeypatch):
        monkeypatch.delenv("KUNMING_INTERACTIVE", raising=False)
        monkeypatch.delenv("KUNMING_GATEWAY_SESSION", raising=False)
        monkeypatch.setenv("KUNMING_EXEC_ASK", "1")
...
class TestScheduleCronjob:
    ...
    def test_thread_id_captured_in_origin(self, monkeypatch):
        ...
        monkeypatch.setenv("KUNMING_SESSION_CHAT_ID", "123456")
        monkeypatch.setenv("KUNMING_SESSION_THREAD_ID", "42")
