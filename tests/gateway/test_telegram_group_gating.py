...
def _make_adapter(require_mention=None, free_response_chats=None, mention_patterns=None):
    ...
    adapter._bot = SimpleNamespace(id=999, username="KUNMING_bot")
...
def _mention_entity(text, mention="@KUNMING_bot"):
...
def test_group_messages_can_require_direct_trigger_via_config():
    ...
    assert adapter._should_process_message(_group_message("hi @KUNMING_bot", entities=[_mention_entity("hi @KUNMING_bot")])) is True
