...
class TestBlockingApprovalE2E:
    ...
    def test_blocking_approval_approve_once(self):
        ...
        def agent_thread():
            ...
            os.environ["KUNMING_SESSION_KEY"] = session_key
            try:
                result_holder[0] = check_all_command_guards(
                    "rm -rf /important", "local"
                )
            finally:
                os.environ.pop("KUNMING_EXEC_ASK", None)
                os.environ.pop("KUNMING_SESSION_KEY", None)
...
class TestFallbackNoCallback:
    ...
    def test_no_callback_returns_approval_required(self):
        ...
        os.environ["KUNMING_EXEC_ASK"] = "1"
        os.environ["KUNMING_SESSION_KEY"] = "no-callback-test"
        try:
