...
class TestGatewayIntegration(unittest.TestCase):
    ...
    def test_feishu_toolset_exists(self):
        ...
        self.assertIn("kunming-feishu", TOOLSETS)
        ...
        class _ChatAPI:
            def get(self, request):
                ...
                return SimpleNamespace(
                    success=lambda: True,
                    data=SimpleNamespace(name="Kunming Group", chat_type="group"),
                )
...
class TestAdapterBehavior(unittest.TestCase):
    ...
    def test_group_post_message_uses_parsed_mentions_when_sdk_mentions_missing(self):
        ...
        message = SimpleNamespace(
            message_type="post",
            mentions=[],
            content='{"en_us":{"content":[[{"tag":"at","user_name":"Kunming","open_id":"ou_bot"}]]}}',
        )
    ...
    @patch.dict(
        os.environ,
        {
            "KUNMING_FEISHU_TEXT_BATCH_MAX_MESSAGES": "2",
        },
        clear=True,
    )
    ...
    def test_dedup_state_persists_across_adapter_restart(self):
        ...
        with tempfile.TemporaryDirectory() as temp_home:
            with patch.dict(os.environ, {"KUNMING_HOME": temp_home}, clear=False):
