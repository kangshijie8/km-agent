...
class TestVoiceInHelp:
    ...
    def test_voice_is_known_command(self):
        ...
        from kunming_cli.commands import GATEWAY_KNOWN_COMMANDS
...
class TestVoiceChannelCommands:
    ...
    async def test_join_missing_voice_dependencies(self, runner):
        ...
        assert "kunming-agent[messaging]" in result
...
class TestSendVoiceReplyCleanup:
    ...
    async def test_files_cleaned_on_send_exception(self, tmp_path):
        ...
        fake_audio = tmp_path / "kunming_voice"
        fake_audio.mkdir()
...
class TestVoiceChannelAwareness:
    ...
    def _make_adapter(self):
        ...
        adapter._voice_receivers = {}
        adapter._client = MagicMock()
        adapter._client.user = SimpleNamespace(id=99999, name="KunmingBot")
        return adapter
    ...
    def test_returns_info_with_members(self):
        ...
        bot_member = self._make_member(99999, "KunmingBot", is_bot=True)
        ...
        assert "Bob" in names
        assert "KunmingBot" not in names
