...
Both expose an OpenAI-compatible `/v1/chat/completions` endpoint. Kunming works with either one — just point it at `http://localhost:8080` or `http://localhost:8000`.
