...
slug: /
sidebar_position: 0
title: "Kunming Agent Documentation"
description: "The self-improving AI agent built by  Research. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
hide_table_of_contents: true
---

# Kunming Agent

The self-improving AI agent built by [ Research](https://). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
<div style={{display: 'flex', gap: '1rem', marginBottom: '2rem', flexWrap: 'wrap'}}>
  ...
  <a href="https://github.com/kangshijie8/KM-Agent" style={{display: 'inline-block', padding: '0.6rem 1.2rem', border: '1px solid rgba(255,215,0,0.2)', borderRadius: '8px', textDecoration: 'none'}}>View on GitHub</a>
</div>

## What is Kunming Agent?
...
| 🔌 **[MCP Integration](/docs/user-guide/features/mcp)** | Connect to MCP servers, filter their tools, and extend Kunming safely |
| 🧭 **[Use MCP with Kunming](/docs/guides/use-mcp-with-kunming)** | Practical MCP setup patterns, examples, and tutorials |
| 🎙️ **[Voice Mode](/docs/user-guide/features/voice-mode)** | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Kunming](/docs/guides/use-voice-mode-with-kunming)** | Hands-on setup and usage patterns for Kunming voice workflows |
| 🎭 **[Personality & SOUL.md](/docs/user-guide/features/personality)** | Define Kunming' default voice with a global SOUL.md |
...
| 💡 **[Tips & Best Practices](/docs/guides/tips)** | Quick wins to get the most out of Kunming |
...
- **Built by model trainers** — Created by [ Research](https://), the lab behind Kunming, Nomos, and Psyche. Works with [Nous Portal](https://portal.), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [ Research](https://) — the lab behind Kunming, Nomos, and Psyche models
