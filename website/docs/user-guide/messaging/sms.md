...
title: "SMS (Twilio)"
description: "Set up Kunming Agent as an SMS chatbot via Twilio"
---

# SMS Setup (Twilio)

Kunming connects to SMS through the [Twilio](https://www.twilio.com/) API. People text your Twilio phone number and get AI responses back — same conversational experience as Telegram or Discord, but over standard text messages.
...
- **aiohttp** — `pip install 'kunming-agent[sms]'`
...
If you're running Kunming locally, use a tunnel to expose the webhook:
...
Text your Twilio number — Kunming will respond via SMS.
...
3. Check km gateway logs for Twilio API errors
