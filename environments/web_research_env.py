...
Inspired by: GroceryMind — production Kunming agent doing live web research
             across German grocery stores (firecrawl + kunming-agent)
"""
...
class WebResearchEnvConfig(KunmingAgentEnvConfig):
...
class WebResearchEnv(KunmingAgentBaseEnv):
    """
