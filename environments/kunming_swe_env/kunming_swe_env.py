"""
KunmingSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    vllm serve YourModel --tool-parser kunming
    run-api
    python environments/kunming_swe_env.py serve \\
...
class KunmingSweEnv(KunmingAgentBaseEnv):
    ...
    name = "kunming-swe"
    env_config_cls = KunmingSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[KunmingSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        """
        env_config = KunmingSweEnvConfig(
            ...
            tool_call_parser="kunming",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="kunming-swe",
        )

        server_configs = [
            APIServerConfig(
                base_url="http://localhost:8000/v1",
                model_name="kangshijie8/Kunming-Model",
