...
The evaluate flow:
    ...
    2. evaluate()  -- Iterates over all runs sequentially through:
        a. rollout_and_score_eval()  -- Per-run agent loop
            ...
            - Runs KunmingAgentLoop with terminal tool only
...
Requires: pip install kunming-agent[yc-bench]
"""
...
class YCBenchEvalConfig(KunmingAgentEnvConfig):
    """
    Configuration for the YC-Bench evaluation environment.

    Extends KunmingAgentEnvConfig with YC-Bench-specific settings for
...
class YCBenchEvalEnv(KunmingAgentBaseEnv):
    """
    ...
    a competing built-in agent loop). The KunmingAgentLoop then drives the
    ...
    async def rollout_and_score_eval(self, eval_item: Dict[str, Any]) -> Dict:
        ...
        3. Runs KunmingAgentLoop with terminal tool
        ...
        try:
            ...
            # LiteLLM), which would compete with our KunmingAgentLoop.
            ...
            # ----------------------------------------------------------
            # Step 2: Run the KunmingAgentLoop
            # ----------------------------------------------------------
