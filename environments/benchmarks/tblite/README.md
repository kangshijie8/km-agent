...
- **Dataset (ours):** [kangshijie8/Kunming-Model](https://huggingface.co/datasets/kangshijie8/openthoughts-tblite)
- **Docker images:** `kangshijie8/Kunming-Model on Docker Hub (100 images)
...
| Setting        | TB2                              | TBLite                                  |
|----------------|----------------------------------|-----------------------------------------|
| Dataset        | `kangshijie8/Kunming-Model  | `kangshijie8/Kunming-Model      |
| Tasks          | 89                               | 100                                     |
