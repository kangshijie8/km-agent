...
Training tasks (3):
    1. Create ~/greeting.txt with "Hello from Kunming Agent"
...
TRAIN_TASKS = [
    {
        "prompt": "Create a file at ~/greeting.txt containing exactly the text: Hello from Kunming Agent",
        "verify_path": "~/greeting.txt",
        "expected_content": "Hello from Kunming Agent",
    },
    {
...
class TerminalTestEnv(KunmingAgentBaseEnv):
    ...
    def config_init(cls) -> Tuple[TerminalTestEnvConfig, List[APIServerConfig]]:
        ...
        Claude for inference. API keys loaded from ~/kunming-agent/.env.
        """
