"""
Monkey patches for making kunming-agent tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by kunming_base_env.py).
