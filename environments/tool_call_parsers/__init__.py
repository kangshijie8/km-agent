"""Kunming tool call parsers for different model formats."""
...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("kunming")
        class KunmingToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "kunming", "mistral", "llama3_json")
...
from environments.tool_call_parsers.kunming_parser import KunmingToolCallParser  # noqa: E402, F401
