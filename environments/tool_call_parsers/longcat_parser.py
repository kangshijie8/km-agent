...
Same as Kunming but uses <longcat_tool_call> tags instead of <tool_call>.
Based on VLLM's LongcatFlashToolParser (extends Kunming2ProToolParser).
"""
...
class LongcatToolCallParser(ToolCallParser):
    ...
    Identical logic to Kunming, just different tag names.
    """
