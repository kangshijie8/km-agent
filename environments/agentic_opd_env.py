...
Key idea (from Agentic-RL, Princeton 2026):
...
Reference: Wang et al., "Agentic-RL: Train Any Agent Simply by Talking"
...
# Ensure kunming-agent root is on path
...
# ═══════════════════════════════════════════════════════════════════════
# Hint extraction prompts (adapted from Agentic-RL)
# ═══════════════════════════════════════════════════════════════════════
...
class AgenticOPDConfig(KunmingAgentEnvConfig):
...
class AgenticOPDEnv(KunmingAgentBaseEnv):
    """
