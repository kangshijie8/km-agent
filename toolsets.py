...
TOOLSETS = {
    ...
    # ==========================================================================
    # Full Kunming toolsets (CLI + messaging platforms)
    #
    ...
    "kunming-email": {
        "description": "Email bot toolset - interact with Kunming via email (IMAP/SMTP)",
        "tools": _KUNMING_CORE_TOOLS,
        "includes": []
    },
    ...
    "kunming-sms": {
        "description": "SMS bot toolset - interact with Kunming via SMS (Twilio)",
        "tools": _KUNMING_CORE_TOOLS,
        "includes": []
    },
    ...
    "kunming-gateway": {
        ...
        "tools": [],
        "includes": ["kunming-telegram", "kunming-discord", "kunming-whatsapp", "kunming-slack", "kunming-signal", "kunming-bluebubbles", "kunming-homeassistant", "kunming-email", "kunming-sms", "kunming-mattermost", "kunming-matrix", "kunming-dingtalk", "kunming-feishu", "kunming-wecom", "kunming-webhook"]
    }
}
