...
version: 1.1.0
author: Kunming Agent (adapted from obra/superpowers)
license: MIT
metadata:
  kunming:
...
> **For Kunming:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use km tools to understand the project:
