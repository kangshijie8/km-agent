...
```bash
python3 -m pyfiglet "KUNMING" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=KUNMING&font=Slant" | boxes -d stone
```
