...
Built for [Kunming Agent](https://github.com/kangshijie8/KM-Agent). Usable in any coding agent. Canonical source lives here; synced to [`kangshijie8/Kunming-Model](https://github.com/kangshijie8/KM-Agent/tree/main/skills/creative/ascii-video) via PR.
