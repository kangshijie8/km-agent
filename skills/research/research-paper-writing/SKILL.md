...
## Kunming Agent Integration

This skill is designed for the Kunming agent. It uses km tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other km skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.kunming/plans/` | `skill_view("plan")` |
