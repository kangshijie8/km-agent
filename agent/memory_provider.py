...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - kunming_home (str): The active KUNMING_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.kunming``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "kunming").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'kunming memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], kunming_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'kunming memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``kunming_home`` is the active KUNMING_HOME directory path.
