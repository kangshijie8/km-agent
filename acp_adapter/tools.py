"""ACP tool-call helpers for mapping km tools to ACP ToolKind and building content."""
...
# ---------------------------------------------------------------------------
# Map kunming tool names -> ACP ToolKind
# ---------------------------------------------------------------------------
...
def get_tool_kind(tool_name: str) -> ToolKind:
    """Return the ACP ToolKind for a kunming tool, defaulting to 'other'."""
...
def build_tool_start(
    ...
    """Create a ToolCallStart event for the given kunming tool invocation."""
