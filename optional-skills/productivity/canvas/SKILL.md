...
4. Name the token (e.g., "Kunming Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.kunming/.env`:
...
```bash
CANVAS="python $KUNMING_HOME/skills/productivity/canvas/scripts/canvas_api.py"
