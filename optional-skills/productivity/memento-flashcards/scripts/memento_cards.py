...
Data file: $KUNMING_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_KUNMING_HOME = Path(os.environ.get("KUNMING_HOME", Path.home() / ".kunming"))
DATA_DIR = _KUNMING_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
